...
const medir = (pessoa) => `${pessoa.nome}, ${pessoa.nome.length}, ${pessoa.idade}, ${pessoa.profissao}, ${pessoa.profissao.length}`
console.log(medir(objeto2))
console.log(medir(objeto1))
