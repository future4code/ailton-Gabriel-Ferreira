const myBirthYear: number = 2001;
const myEmissionYear: number = 2018;
const myActualYear: number = 2022;
...
console.log(checaRenovacaoRG(myActualYear, myBirthYear, myEmissionYear));
